...
[Materials]
  [./pfbulkmat]
    ...
    prop_names = 'gc_prop l visco ductile_damage neta theta'
    prop_values = '1e-1 0.05 5e-3 0.1 0.3334 1.0472'
  [../]
  [./elasticity_tensor]
  ...
  [../]
  [./cracked_stress]
    type = ComputeCleavageFractureStress
    c = c
    F_name = Griffth
    uncracked_base_name = uncracked
    critical_crack_length = 0.001
    youngs_modulus = 208
    gc_ini = 1e-2
    gc_inf = 1e-3
    fracture_toughness_degradation_factor = 1.0
  [../]
[]
